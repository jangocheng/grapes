...
import { GrapesTestModule } from '../../../test.module';
import { NxtHealthCheckComponent } from '../../../../../../main/webapp/app/admin/health/health.component';
import { NxtHealthService } from '../../../../../../main/webapp/app/admin/health/health.service';

describe('Component Tests', () => {

    describe('NxtHealthCheckComponent', () => {

        let comp: NxtHealthCheckComponent;
        let fixture: ComponentFixture<NxtHealthCheckComponent>;
        let service: NxtHealthService;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [GrapesTestModule],
                declarations: [NxtHealthCheckComponent],
                providers: [
                    NxtHealthService
                ]
            })
            .overrideTemplate(NxtHealthCheckComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(NxtHealthCheckComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(NxtHealthService);
        });
