...
import { NxtLoginModalComponent } from '../../../../../../main/webapp/app/shared/login/login.component';
...
describe('Component Tests', () => {
    ...
    describe('LoginComponent', () => {
        ...
        let comp: NxtLoginModalComponent;
        let fixture: ComponentFixture<NxtLoginModalComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [NxtLoginModalComponent],
                providers : [
                    {
            ...
            .overrideTemplate(NxtLoginModalComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(NxtLoginModalComponent);
